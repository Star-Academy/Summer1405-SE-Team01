...
namespace Mini_query_builder.Tests.Executors
{
    public class SQLServerExecutorTests
    {
        ...
        private readonly ISQLServerExecutorPrintResult _sqlServerExecutorPrintResult = Substitute.For<ISQLServerExecutorPrintResult>();
        ...
        {
            _sut = new SQLServerExecutor(_sqlServerExecutorConnection, _sqlServerExecutorPrintResult, _sqlServerExecutorAddParameters, _sqlServerCommandExecutor);

            _sqlServerCommandExecutor.ExecuteReader(Arg.Any<SqlCommand>()).Returns(_dataReader);
            _sqlServerExecutorPrintResult.PrintQueryResult(Arg.Any<IDataReader>()).Returns(new List<string>());
        }
        ...
        public void ExecuteOnSqlServer_ShouldPrintTheReaderReturnedByCommandExecutor_Whenever()
        {
            ...
            // Assert
            _sqlServerExecutorPrintResult.Received(1).PrintQueryResult(_dataReader);
        }
    }
}