...
public class PostgresIntegrationTests : IClassFixture<PostgresContainerFixture>, IAsyncLifetime
{
    ...
    private INpgSqlExecutor _sut = null!;
    ...
    public Task InitializeAsync()
    {
        ...
        _sut = new NpgsqlExecutor(
            new NpgSqlExecutorConnection(),
            new ExecutorGetResult(),
            new NpgSqlExecutorAddParameter(),
    ...
    private Task<List<Dictionary<string, object>>> RunQueryAsync(Query query)
    {
        ...
        var result = _sut.ExecuteOnPostgres(compiled, _connectionString);
    ...
    [Fact]
    public async Task Query_ShouldFilterByIsNull_When_ConditionValueIsNull()
    {
